...
3. git commit the train.py, with one sentence describing your change and prefix "experiment: "
...
9. If val_bpb is equal or worse, you git reset hard the train.py back to where you started
